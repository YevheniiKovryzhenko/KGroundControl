...
namespace remote_control {
    ...
    public:
        ...
        JoystickCommandSettings commandSettings(int idx) const;
        void addCommand(const JoystickCommandSettings& s);
        void removeCommand(int idx);
        void updateCommandSettings(int idx, const JoystickCommandSettings& s);
        void saveCommands();
